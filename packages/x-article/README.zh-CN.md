...
完整协议（请求头、请求体、响应结构、映射规则）见 [`docs/x-article-publish-protocol.md`](../../docs/x-article-publish-protocol.md)。
...
完整规则、entity key 约定与 UTF-16 offset 语义见 [`docs/x-article-publish-protocol.md`](../../docs/x-article-publish-protocol.md)。
...
- 基于 relay 构建你自己的插件或上传端：[`docs/integrate-browser-extension.md`](../../docs/integrate-browser-extension.md)
